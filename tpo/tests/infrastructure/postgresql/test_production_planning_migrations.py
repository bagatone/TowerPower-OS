...
def test_revision_chain_e_nuovo_head() -> None:
    ...
    assert [item.revision for item in revisions[:17]] == [
        "20260903_0027", "20260903_0026", "20260903_0025", "20260903_0024", "20260903_0023", "20260830_0022", "20260826_0021", "20260825_0020", "20260825_0019", "20260824_0018",
...
def test_upgrade_0004_downgrade_e_reupgrade(tmp_path: Path) -> None:
    ...
    try:
        ...
        assert connection.exec_driver_sql("SELECT version_num FROM alembic_version").scalar_one() == "20260903_0027"
