...
def test_revision_chain_e_nuovo_head() -> None:
    ...
    assert [item.revision for item in revisions[:16]] == [
        ...
        "20260815_0013", "20260814_0012", "20260814_0011", "20260814_0010", "20260812_0009", "20260811_0008",
    ]
    assert [item.down_revision for item in revisions[:15]] == [
        "20260830_0022", "20260826_0021", "20260825_0020", "20260825_0019", "20260824_0018", "20260824_0017", "20260823_0016", "20260822_0015", "20260822_0014", "20260815_0013",
        "20260814_0012", "20260814_0011", "20260814_0010", "20260812_0009", "20260811_0008",
    ]
...
def test_upgrade_0004_downgrade_e_reupgrade(tmp_path: Path) -> None:
    ...
    try:
        ...
        assert connection.exec_driver_sql("SELECT version_num FROM alembic_version").scalar_one() == "20260903_0023"
