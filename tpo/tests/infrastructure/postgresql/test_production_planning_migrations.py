...
def test_revision_chain_e_nuovo_head() -> None:
    ...
    assert [item.revision for item in revisions[:20]] == [
        ...
        "20260825_0020", "20260825_0019", "20260824_0018", "20260824_0017", "20260823_0016", "20260822_0015", "20260822_0014",
    ]
    assert [item.down_revision for item in revisions[:19]] == [
        ...
        "20260825_0019", "20260824_0018", "20260824_0017", "20260823_0016", "20260822_0015", "20260822_0014",
    ]
...
def test_upgrade_0004_downgrade_e_reupgrade(tmp_path: Path) -> None:
    ...
    try:
        ...
        assert connection.exec_driver_sql("SELECT version_num FROM alembic_version").scalar_one() == "20260915_0033"
